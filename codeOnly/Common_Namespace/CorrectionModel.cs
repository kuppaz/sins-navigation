...
namespace Common_Namespace
{
    public class CorrectionModel : SimpleOperations
    {
        ...
        public static void Make_H_VELOCITY(Kalman_Vars KalmanVars, SINS_State SINSstate, SINS_State SINSstate_OdoMod)
        {
            ...
            if (SINSstate.flag_UseOdoVelocity_In_Oz == false)
            {
                for (int i = 0; i < 3; i++)
            ...
            //--------------------------------------
            else if (SINSstate.flag_UseOdoVelocity_In_Oz == true)
            {
                ...
                KalmanVars.Measure[(KalmanVars.cnt_measures + 0)] = SINSstate.A_sx0[0, 0] * SINSstate.Vx_0[0] + SINSstate.A_sx0[0, 1] * SINSstate.Vx_0[1] + SINSstate.A_sx0[0, 2] * SINSstate.Vx_0[2];
                KalmanVars.Measure[(KalmanVars.cnt_measures + 1)] = SINSstate.A_sx0[1, 0] * SINSstate.Vx_0[0] + SINSstate.A_sx0[1, 1] * SINSstate.Vx_0[1] + SINSstate.A_sx0[1, 2] * SINSstate.Vx_0[2] - SINSstate.OdoSpeed_s[1];
                ...
                if (SINSstate.flag_iMx_kappa_13_ds && SINSstate.flag_OdoModelOnlyCP == false)
                {
                    KalmanVars.Matrix_H[(KalmanVars.cnt_measures + 0) * iMx + iMx_odo_model + 1] = -SINSstate.OdoSpeed_s[1];
                    KalmanVars.Matrix_H[(KalmanVars.cnt_measures + 1) * iMx + iMx_odo_model + 2] = -SINSstate.OdoSpeed_s[1];
                }
                KalmanVars.cnt_measures += 2;
                ...
                if (SINSstate.flag_iMx_r3_dV3)
                {
                    KalmanVars.Matrix_H[(KalmanVars.cnt_measures + 0) * iMx + 2] = SINSstate.A_sx0[2, 0];
                    KalmanVars.Matrix_H[(KalmanVars.cnt_measures + 0) * iMx + 3] = SINSstate.A_sx0[2, 1];
                    KalmanVars.Matrix_H[(KalmanVars.cnt_measures + 0) * iMx + iMx_r3_dV3 + 1] = SINSstate.A_sx0[2, 2];

                    KalmanVars.Matrix_H[(KalmanVars.cnt_measures - 2) * iMx + iMx_r3_dV3 + 1] = SINSstate.A_sx0[0, 2];
                    KalmanVars.Matrix_H[(KalmanVars.cnt_measures - 1) * iMx + iMx_r3_dV3 + 1] = SINSstate.A_sx0[1, 2];

                    if (SINSstate.flag_iMx_kappa_13_ds && SINSstate.flag_OdoModelOnlyCP == false)
                    {
                        KalmanVars.Matrix_H[(KalmanVars.cnt_measures + 0) * iMx + iMx_odo_model + 0] = SINSstate.OdoSpeed_s[1];
                    }

                    KalmanVars.Measure[(KalmanVars.cnt_measures + 0)] = SINSstate.A_sx0[2, 0] * SINSstate.Vx_0[0] + SINSstate.A_sx0[2, 1] * SINSstate.Vx_0[1] + SINSstate.A_sx0[2, 2] * SINSstate.Vx_0[2];
                    KalmanVars.Noize_Z[(KalmanVars.cnt_measures + 0)] = 0.001;
