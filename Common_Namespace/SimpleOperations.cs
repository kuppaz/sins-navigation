...
namespace Common_Namespace
{
    public class SimpleOperations
    {
        ...
        public static void MakeMatrixFromVector(Matrix Matrix_out, double[] Vector_in, int dim)
        {
            ...
            //в принципе можно переписать с использованием операторов для матриц и векторов
        public static void InitOfKalmanMatrix_A(SINS_State SINSstate, Kalman_Vars KalmanVars)
        {
