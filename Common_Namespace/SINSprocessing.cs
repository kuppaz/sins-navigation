    ...
    public class SINSprocessing : SimpleOperations
    {
        ...
        public static void StateCorrection(double[] ErrorVector, SINS_State SINSstate, SINS_State SINSstate2, SINS_State SINSstate_OdoMod, Kalman_Vars KalmanVars)
        {
            ...
            if (SINSstate.flag_FeedbackExist)
            {
                ...
                {
                    SINSstate2.Cumulative_KappaEst[0] += ErrorVector[SINSstate.value_iMx_kappa_13_ds + 0];
                    SINSstate2.Cumulative_KappaEst[2] += ErrorVector[SINSstate.value_iMx_kappa_13_ds + 1];
                    SINSstate2.Cumulative_KappaEst[1] += ErrorVector[SINSstate.value_iMx_kappa_13_ds + 2];
                }
        ...
        public static void InitOfCovarianceMatrixes(SINS_State SINSstate, Kalman_Vars KalmanVars)
        {
            ...
            KalmanVars.CovarianceMatrixS_m[(SINSstate.value_iMx_dV_12 + 0) * SimpleData.iMx + (SINSstate.value_iMx_dV_12 + 0)] 
                = KalmanVars.CovarianceMatrixS_p[(SINSstate.value_iMx_dV_12 + 0) * SimpleData.iMx + (SINSstate.value_iMx_dV_12 + 0)] = SINSstate.stdV;   // 0.01 м/с
            KalmanVars.CovarianceMatrixS_m[(SINSstate.value_iMx_dV_12 + 1) * SimpleData.iMx + (SINSstate.value_iMx_dV_12 + 1)]
                = KalmanVars.CovarianceMatrixS_p[(SINSstate.value_iMx_dV_12 + 1) * SimpleData.iMx + (SINSstate.value_iMx_dV_12 + 1)] = SINSstate.stdV;

            KalmanVars.CovarianceMatrixS_m[(SINSstate.value_iMx_alphaBeta + 0) * SimpleData.iMx + (SINSstate.value_iMx_alphaBeta + 0)]
                = KalmanVars.CovarianceMatrixS_p[(SINSstate.value_iMx_alphaBeta + 0) * SimpleData.iMx + (SINSstate.value_iMx_alphaBeta + 0)] = Math.Sign(SINSstate.stdAlpha1) * Math.Max(Math.Abs(SINSstate.stdAlpha1), 1E-6);  // 5 угл. минут
            KalmanVars.CovarianceMatrixS_m[(SINSstate.value_iMx_alphaBeta + 1) * SimpleData.iMx + (SINSstate.value_iMx_alphaBeta + 1)]
                = KalmanVars.CovarianceMatrixS_p[(SINSstate.value_iMx_alphaBeta + 1) * SimpleData.iMx + (SINSstate.value_iMx_alphaBeta + 1)] = Math.Sign(SINSstate.stdAlpha2) * Math.Max(Math.Abs(SINSstate.stdAlpha2), 1E-6);
            KalmanVars.CovarianceMatrixS_m[(SINSstate.value_iMx_alphaBeta + 2) * SimpleData.iMx + (SINSstate.value_iMx_alphaBeta + 2)]
                = KalmanVars.CovarianceMatrixS_p[(SINSstate.value_iMx_alphaBeta + 2) * SimpleData.iMx + (SINSstate.value_iMx_alphaBeta + 2)] = Math.Sign(SINSstate.stdBeta3) * Math.Max(Math.Abs(SINSstate.stdBeta3), 1E-6);

            KalmanVars.CovarianceMatrixS_m[(SINSstate.value_iMx_Nu0 + 0) * SimpleData.iMx + (SINSstate.value_iMx_Nu0 + 0)]
                = KalmanVars.CovarianceMatrixS_p[(SINSstate.value_iMx_Nu0 + 0) * SimpleData.iMx + (SINSstate.value_iMx_Nu0 + 0)] = Math.Sign(SINSstate.stdNu_Oz[0]) * Math.Max(Math.Abs(SINSstate.stdNu_Oz[0]) * SimpleData.ToRadian / 3600.0, 1E-10); //0.2 * SimpleData.ToRadian / 3600.0; // 0.2 град/час
            KalmanVars.CovarianceMatrixS_m[(SINSstate.value_iMx_Nu0 + 1) * SimpleData.iMx + (SINSstate.value_iMx_Nu0 + 1)]
                = KalmanVars.CovarianceMatrixS_p[(SINSstate.value_iMx_Nu0 + 1) * SimpleData.iMx + (SINSstate.value_iMx_Nu0 + 1)] = Math.Sign(SINSstate.stdNu_Oz[1]) * Math.Max(Math.Abs(SINSstate.stdNu_Oz[1]) * SimpleData.ToRadian / 3600.0, 1E-10);//0.2 * SimpleData.ToRadian / 3600.0;
            KalmanVars.CovarianceMatrixS_m[(SINSstate.value_iMx_Nu0 + 2) * SimpleData.iMx + (SINSstate.value_iMx_Nu0 + 2)]
                = KalmanVars.CovarianceMatrixS_p[(SINSstate.value_iMx_Nu0 + 2) * SimpleData.iMx + (SINSstate.value_iMx_Nu0 + 2)] = Math.Sign(SINSstate.stdNu_Oz[2]) * Math.Max(Math.Abs(SINSstate.stdNu_Oz[2]) * SimpleData.ToRadian / 3600.0, 1E-10);//0.2 * SimpleData.ToRadian / 3600.0;

            KalmanVars.CovarianceMatrixS_m[(SINSstate.value_iMx_f0_12 + 0) * SimpleData.iMx + (SINSstate.value_iMx_f0_12 + 0)]
                = KalmanVars.CovarianceMatrixS_p[(SINSstate.value_iMx_f0_12 + 0) * SimpleData.iMx + (SINSstate.value_iMx_f0_12 + 0)] = Math.Sign(SINSstate.stdF_Oz[0]) * Math.Max(Math.Abs(SINSstate.stdF_Oz[0]), 1E-6);    // м/с^2
            KalmanVars.CovarianceMatrixS_m[(SINSstate.value_iMx_f0_12 + 1) * SimpleData.iMx + (SINSstate.value_iMx_f0_12 + 1)]
                = KalmanVars.CovarianceMatrixS_p[(SINSstate.value_iMx_f0_12 + 1) * SimpleData.iMx + (SINSstate.value_iMx_f0_12 + 1)] = Math.Sign(SINSstate.stdF_Oz[1]) * Math.Max(Math.Abs(SINSstate.stdF_Oz[1]), 1E-6);

            KalmanVars.CovarianceMatrixS_m[(SINSstate.value_iMx_f0_3 + 0) * SimpleData.iMx + (SINSstate.value_iMx_f0_3 + 0)]
                = KalmanVars.CovarianceMatrixS_p[(SINSstate.value_iMx_f0_3 + 0) * SimpleData.iMx + (SINSstate.value_iMx_f0_3 + 0)] = Math.Sign(SINSstate.stdF_Oz[2]) * Math.Max(Math.Abs(SINSstate.stdF_Oz[2]), 1E-6);

            if (SINSstate.flag_iMx_r3_dV3 == true)
            {
                KalmanVars.CovarianceMatrixS_m[SINSstate.value_iMx_dr3 * SimpleData.iMx + SINSstate.value_iMx_dr3]
                    = KalmanVars.CovarianceMatrixS_p[SINSstate.value_iMx_dr3 * SimpleData.iMx + SINSstate.value_iMx_dr3] = SINSstate.stdR;
            }

            if (SINSstate.flag_iMx_r3_dV3 == true)
            {
                KalmanVars.CovarianceMatrixS_m[(SINSstate.value_iMx_dV3 + 0) * SimpleData.iMx + (SINSstate.value_iMx_dV3 + 0)]
                    = KalmanVars.CovarianceMatrixS_p[(SINSstate.value_iMx_dV3 + 0) * SimpleData.iMx + (SINSstate.value_iMx_dV3 + 0)] = SINSstate.stdV;
            }
            ...
            if (SINSstate.flag_iMx_kappa_13_ds == true)
            {
                KalmanVars.CovarianceMatrixS_m[SINSstate.value_iMx_kappa_13_ds * SimpleData.iMx + SINSstate.value_iMx_kappa_13_ds]
                    = KalmanVars.CovarianceMatrixS_p[SINSstate.value_iMx_kappa_13_ds * SimpleData.iMx + SINSstate.value_iMx_kappa_13_ds] = SINSstate.stdKappa1 * SimpleData.ToRadian_min;
                KalmanVars.CovarianceMatrixS_m[(SINSstate.value_iMx_kappa_13_ds + 1) * SimpleData.iMx + (SINSstate.value_iMx_kappa_13_ds + 1)]
                    = KalmanVars.CovarianceMatrixS_p[(SINSstate.value_iMx_kappa_13_ds + 1) * SimpleData.iMx + (SINSstate.value_iMx_kappa_13_ds + 1)] = SINSstate.stdKappa3 * SimpleData.ToRadian_min;
                KalmanVars.CovarianceMatrixS_m[(SINSstate.value_iMx_kappa_13_ds + 2) * SimpleData.iMx + (SINSstate.value_iMx_kappa_13_ds + 2)]
                    = KalmanVars.CovarianceMatrixS_p[(SINSstate.value_iMx_kappa_13_ds + 2) * SimpleData.iMx + (SINSstate.value_iMx_kappa_13_ds + 2)] = SINSstate.stdScale;
            }
            ...
            if (SINSstate.flag_SeparateHorizVSVertical == true)
            {
                int iMxV = SimpleData.iMx_Vertical,
                    iMxAlpha = SINSstate.Vertical_alphaBeta,
                    iMxNu = SINSstate.Vertical_nu0,
                    f0_12 = SINSstate.Vertical_f0_12,
                    f0_3 = SINSstate.Vertical_f0_3
                    ;

                for (int i = 0; i < iMxV * iMxV; i++)
                    KalmanVars.Vertical_CovarianceMatrixS_m[i] = KalmanVars.Vertical_CovarianceMatrixS_p[i] = 0.0;
                ...
                {
                    KalmanVars.Vertical_CovarianceMatrixS_m[(iMxAlpha + 0) * iMxV + iMxAlpha + 0] = KalmanVars.Vertical_CovarianceMatrixS_p[(iMxAlpha + 0) * iMxV + iMxAlpha + 0] 
                        = Math.Sign(SINSstate.stdAlpha1) * Math.Max(Math.Abs(SINSstate.stdAlpha1), 1E-6);
                    KalmanVars.Vertical_CovarianceMatrixS_m[(iMxAlpha + 1) * iMxV + iMxAlpha + 1] = KalmanVars.Vertical_CovarianceMatrixS_p[(iMxAlpha + 1) * iMxV + iMxAlpha + 1] 
                        = Math.Sign(SINSstate.stdAlpha2) * Math.Max(Math.Abs(SINSstate.stdAlpha2), 1E-6);
                    KalmanVars.Vertical_CovarianceMatrixS_m[(iMxAlpha + 2) * iMxV + iMxAlpha + 2] = KalmanVars.Vertical_CovarianceMatrixS_p[(iMxAlpha + 2) * iMxV + iMxAlpha + 2] 
                        = Math.Sign(SINSstate.stdBeta3) * Math.Max(Math.Abs(SINSstate.stdBeta3), 1E-6);
                }

                if (SINSstate.Vertical_nu0 > 0)
                {
                    KalmanVars.Vertical_CovarianceMatrixS_m[(iMxNu + 0) * iMxV + (iMxNu + 0)] = KalmanVars.Vertical_CovarianceMatrixS_p[(iMxNu + 0) * iMxV + (iMxNu + 0)] 
                        = Math.Sign(SINSstate.stdNu_Oz[0]) * Math.Max(Math.Abs(SINSstate.stdNu_Oz[0]) * SimpleData.ToRadian / 3600.0, 1E-10); //0.2 * SimpleData.ToRadian / 3600.0; // 0.2 град/час
                    KalmanVars.Vertical_CovarianceMatrixS_m[(iMxNu + 1) * iMxV + (iMxNu + 1)] = KalmanVars.Vertical_CovarianceMatrixS_p[(iMxNu + 1) * iMxV + (iMxNu + 1)] 
                        = Math.Sign(SINSstate.stdNu_Oz[1]) * Math.Max(Math.Abs(SINSstate.stdNu_Oz[1]) * SimpleData.ToRadian / 3600.0, 1E-10);//0.2 * SimpleData.ToRadian / 3600.0;
                    KalmanVars.Vertical_CovarianceMatrixS_m[(iMxNu + 2) * iMxV + (iMxNu + 2)] = KalmanVars.Vertical_CovarianceMatrixS_p[(iMxNu + 2) * iMxV + (iMxNu + 2)] 
                        = Math.Sign(SINSstate.stdNu_Oz[2]) * Math.Max(Math.Abs(SINSstate.stdNu_Oz[2]) * SimpleData.ToRadian / 3600.0, 1E-10);//0.2 * SimpleData.ToRadian / 3600.0;
                }

                if (SINSstate.Vertical_f0_12 > 0)
                {
                    KalmanVars.Vertical_CovarianceMatrixS_m[(f0_12 + 0) * iMxV + (f0_12 + 0)] = KalmanVars.Vertical_CovarianceMatrixS_p[(f0_12 + 0) * iMxV + (f0_12 + 0)] = Math.Sign(SINSstate.stdF_Oz[0]) * Math.Max(Math.Abs(SINSstate.stdF_Oz[0]), 1E-6);    // м/с^2
                    KalmanVars.Vertical_CovarianceMatrixS_m[(f0_12 + 1) * iMxV + (f0_12 + 1)] = KalmanVars.Vertical_CovarianceMatrixS_p[(f0_12 + 1) * iMxV + (f0_12 + 1)] = Math.Sign(SINSstate.stdF_Oz[1]) * Math.Max(Math.Abs(SINSstate.stdF_Oz[1]), 1E-6);
                }

                if (SINSstate.Vertical_f0_3 > 0)
                {
                    KalmanVars.Vertical_CovarianceMatrixS_m[f0_3 * iMxV + f0_3] = KalmanVars.Vertical_CovarianceMatrixS_p[f0_3 * iMxV + f0_3] = Math.Sign(SINSstate.stdF_Oz[2]) * Math.Max(Math.Abs(SINSstate.stdF_Oz[2]), 1E-6);
                }
            }
        }
        ...
        public static int MatrixNoise_ReDef(SINS_State SINSstate, Kalman_Vars KalmanVars, bool AlignmentFLG)
        {
            ...
            if (SINSstate.flag_SeparateHorizVSVertical == true)
            {
                ...
                KalmanVars.Vertical_CovarianceMatrixNoise[1 * SimpleData.iMq_Vertical + 0] = Noise_Vel_in_Mx[2] * sqrt_freq;
                Vertical_tmpCounter = Vertical_tmpCounter + 1;

                if (SINSstate.Vertical_alphaBeta > 0)
                {
                    KalmanVars.Vertical_CovarianceMatrixNoise[(SINSstate.Vertical_alphaBeta + 0) * SimpleData.iMq_Vertical + Vertical_tmpCounter + 0] = Noise_Angl_in_Mx[0] * sqrt_freq;
                    KalmanVars.Vertical_CovarianceMatrixNoise[(SINSstate.Vertical_alphaBeta + 1) * SimpleData.iMq_Vertical + Vertical_tmpCounter + 1] = Noise_Angl_in_Mx[1] * sqrt_freq;
                    KalmanVars.Vertical_CovarianceMatrixNoise[(SINSstate.Vertical_alphaBeta + 2) * SimpleData.iMq_Vertical + Vertical_tmpCounter + 2] = Noise_Angl_in_Mx[2] * sqrt_freq;
                }
            }
        ...
        public static void Make_A(SINS_State SINSstate, Kalman_Vars KalmanVars, SINS_State SINSstate_OdoMod)
        {
            ...
            KalmanVars.Matrix_A[(iMx_dV_12 + 0) * iMx + 0] = SINSstate.u_x[0] * SINSstate.Vx_0[1] / SINSstate.R_e;
            ...
            KalmanVars.Matrix_A[(iMx_dV_12 + 0) * iMx + (iMx_alphaBeta + 1)] = -SINSstate.g - SINSstate.u_x[0] * SINSstate.Vx_0[1];
            ...
            KalmanVars.Matrix_A[(iMx_dV_12 + 1) * iMx + 0] = -SINSstate.u_x[0] * SINSstate.Vx_0[0] / SINSstate.R_e;
            ...
            KalmanVars.Matrix_A[(iMx_dV_12 + 1) * iMx + (iMx_alphaBeta + 1)] = SINSstate.u_x[0] * SINSstate.Vx_0[0];
            ...
            KalmanVars.Matrix_A[(iMx_alphaBeta + 1) * iMx + (iMx_alphaBeta + 2)] = SINSstate.u_x[0];
            ...
            KalmanVars.Matrix_A[(iMx_alphaBeta + 2) * iMx + 0] = (SINSstate.Omega_x[0] + SINSstate.u_x[0]) / SINSstate.R_e;
            ...
            KalmanVars.Matrix_A[(iMx_alphaBeta + 2) * iMx + (iMx_alphaBeta + 1)] = -SINSstate.Omega_x[0] - SINSstate.u_x[0];
            ...
            if (SINSstate.flag_iMx_r3_dV3)
            {
                ...
                if (SINSstate.existRelationHoriz_VS_Vertical)
                {
                    ...
                    KalmanVars.Matrix_A[(iMx_dV_12 + 0) * iMx + (iMx_alphaBeta + 2)] += -SINSstate.u_x[0] * SINSstate.Vx_0[2];
                    ...
                    KalmanVars.Matrix_A[(iMx_dV_12 + 1) * iMx + iMx_dV3] = SINSstate.Omega_x[0] + 2 * SINSstate.u_x[0];
                    ...
                    KalmanVars.Matrix_A[iMx_dV3 * iMx + (iMx_dV_12 + 1)] = -SINSstate.Omega_x[0] - 2 * SINSstate.u_x[0];
                }
                ...
                KalmanVars.Matrix_A[iMx_dV3 * iMx + (iMx_alphaBeta + 2)] = SINSstate.u_x[0] * SINSstate.Vx_0[0] + SINSstate.u_x[1] * SINSstate.Vx_0[1];
            ...
            if (SINSstate.flag_SeparateHorizVSVertical == true)
            {
                ...
                if (SINSstate.Vertical_nu0 > 0)
                {
                    KalmanVars.Vertical_Matrix_A[1 * iMxV + iMxNu + 0] = -SINSstate.Vx_0[0] * SINSstate.A_x0s[1, 0] + SINSstate.Vx_0[1] * SINSstate.A_x0s[0, 0];
                    KalmanVars.Vertical_Matrix_A[1 * iMxV + iMxNu + 1] = -SINSstate.Vx_0[0] * SINSstate.A_x0s[1, 1] + SINSstate.Vx_0[1] * SINSstate.A_x0s[0, 1];
                    KalmanVars.Vertical_Matrix_A[1 * iMxV + iMxNu + 2] = -SINSstate.Vx_0[0] * SINSstate.A_x0s[1, 2] + SINSstate.Vx_0[1] * SINSstate.A_x0s[0, 2];
                }


                if (SINSstate.Vertical_alphaBeta > 0)
                {
                    KalmanVars.Vertical_Matrix_A[0 * iMxV + iMxAlpha + 0] = -SINSstate.Vx_0[1];
                    KalmanVars.Vertical_Matrix_A[0 * iMxV + iMxAlpha + 1] = SINSstate.Vx_0[0];

                    KalmanVars.Vertical_Matrix_A[1 * iMxV + iMxAlpha + 0] = -SINSstate.u_x[2] * SINSstate.Vx_0[0];
                    KalmanVars.Vertical_Matrix_A[1 * iMxV + iMxAlpha + 1] = -SINSstate.u_x[2] * SINSstate.Vx_0[1];
                    KalmanVars.Vertical_Matrix_A[1 * iMxV + iMxAlpha + 2] = SINSstate.u_x[0] * SINSstate.Vx_0[0] + SINSstate.u_x[1] * SINSstate.Vx_0[1];


                    KalmanVars.Vertical_Matrix_A[(iMxAlpha + 0) * iMxV + iMxAlpha + 1] = SINSstate.u_x[2];
                    KalmanVars.Vertical_Matrix_A[(iMxAlpha + 0) * iMxV + iMxAlpha + 2] = -SINSstate.u_x[1];
                    if (SINSstate.Vertical_nu0 > 0)
                    {
                        KalmanVars.Vertical_Matrix_A[(iMxAlpha + 0) * iMxV + iMxNu + 0] = -SINSstate.A_x0s[0, 0];
                        KalmanVars.Vertical_Matrix_A[(iMxAlpha + 0) * iMxV + iMxNu + 1] = -SINSstate.A_x0s[0, 1];
                        KalmanVars.Vertical_Matrix_A[(iMxAlpha + 0) * iMxV + iMxNu + 2] = -SINSstate.A_x0s[0, 2];
                    }

                    KalmanVars.Vertical_Matrix_A[(iMxAlpha + 1) * iMxV + iMxAlpha + 0] = -SINSstate.u_x[2];
                    KalmanVars.Vertical_Matrix_A[(iMxAlpha + 1) * iMxV + iMxAlpha + 2] = SINSstate.u_x[0];
                    if (SINSstate.Vertical_nu0 > 0)
                    {
                        KalmanVars.Vertical_Matrix_A[(iMxAlpha + 1) * iMxV + iMxNu + 0] = -SINSstate.A_x0s[1, 0];
                        KalmanVars.Vertical_Matrix_A[(iMxAlpha + 1) * iMxV + iMxNu + 1] = -SINSstate.A_x0s[1, 1];
                        KalmanVars.Vertical_Matrix_A[(iMxAlpha + 1) * iMxV + iMxNu + 2] = -SINSstate.A_x0s[1, 2];
                    }

                    KalmanVars.Vertical_Matrix_A[(iMxAlpha + 2) * iMxV + iMxAlpha + 0] = SINSstate.Omega_x[1] + SINSstate.u_x[1];
                    KalmanVars.Vertical_Matrix_A[(iMxAlpha + 2) * iMxV + iMxAlpha + 1] = -SINSstate.Omega_x[0] - SINSstate.u_x[0];
                    if (SINSstate.Vertical_nu0 > 0)
                    {
                        KalmanVars.Vertical_Matrix_A[(iMxAlpha + 2) * iMxV + iMxNu + 0] = -SINSstate.A_x0s[2, 0];
                        KalmanVars.Vertical_Matrix_A[(iMxAlpha + 2) * iMxV + iMxNu + 1] = -SINSstate.A_x0s[2, 1];
                        KalmanVars.Vertical_Matrix_A[(iMxAlpha + 2) * iMxV + iMxNu + 2] = -SINSstate.A_x0s[2, 2];
                    }
                }
        ...
        //{
        //    //for (int j1 = 0; j1 < SINSstate.iMx_r3_dV3; j1++)
        ...
        //        KalmanVars.CovarianceMatrixS_m[(SINSstate.iMx_r3_dV3) * SimpleData.iMx + j1] = KalmanVars.CovarianceMatrixS_p[(SINSstate.iMx_r3_dV3) * SimpleData.iMx + j1] = 0.0;
        //        KalmanVars.CovarianceMatrixS_m[(SINSstate.iMx_r3_dV3 + 1) * SimpleData.iMx + j1] = KalmanVars.CovarianceMatrixS_p[(SINSstate.iMx_r3_dV3 + 1) * SimpleData.iMx + j1] = 0.0;
        //        KalmanVars.CovarianceMatrixS_m[(SINSstate.iMx_r12_odo + 2) * SimpleData.iMx + j1] = KalmanVars.CovarianceMatrixS_p[(SINSstate.iMx_r12_odo + 2) * SimpleData.iMx + j1] = 0.0;
        //    }
        ...
        public static void FuncSmoothing_BackwardAndSmooth(SINS_State SINSstate, SINS_State SINSstate_Smooth, Kalman_Vars KalmanVars, Proc_Help ProcHelp, StreamReader Back_Input_X, StreamReader Back_Input_P, StreamWriter ForHelpSmoothed)
        {
            ...
            if (SINSstate.flag_iMx_r3_dV3)
            {
                if (SimpleData.iMxSmthd >= 2)
                {
                    ...
                    Matrix MatrixS_ForNavDeltas = new Matrix(tmp_dim, tmp_dim);
                    MatrixS_ForNavDeltas = SimpleOperations.C_convultion_VerticalCoordinate(SINSstate)
                                            * SimpleOperations.ArrayToMatrix(KalmanVars.CovarianceMatrixS_p)
                                            * SimpleOperations.ArrayToMatrix(KalmanVars.CovarianceMatrixS_p).Transpose()
                                            * SimpleOperations.C_convultion_VerticalCoordinate(SINSstate).Transpose()
                                            ;
                    SimpleOperations.CopyArray(KalmanVars.CovarianceMatrix_SP_m, KalmanProcs.rsb_rsb(SimpleOperations.MatrixToArray(MatrixS_ForNavDeltas), tmp_dim));
                ...
                if (SimpleData.iMxSmthd >= 4)
                {
                    ...
                    Matrix MatrixS_ForNavDeltas = new Matrix(tmp_dim, tmp_dim);
                    MatrixS_ForNavDeltas = SimpleOperations.C_convultion_VerticalVelocity(SINSstate)
                                            * SimpleOperations.ArrayToMatrix(KalmanVars.CovarianceMatrixS_p)
                                            * SimpleOperations.ArrayToMatrix(KalmanVars.CovarianceMatrixS_p).Transpose()
                                            * SimpleOperations.C_convultion_VerticalVelocity(SINSstate).Transpose()
                                            ;
                    SimpleOperations.CopyArray(KalmanVars.CovarianceMatrix_SP_m, KalmanProcs.rsb_rsb(SimpleOperations.MatrixToArray(MatrixS_ForNavDeltas), tmp_dim));
            ...
            , StreamWriter Smthing_X, StreamWriter Smthing_P, StreamWriter Smthing_Backward)
        {
            ...
            if (SINSstate.flag_iMx_r3_dV3)
            {
                if (SimpleData.iMxSmthd >= 2)
                {
                    ...
                    MatrixS_For_VerticalCoordinate = SimpleOperations.C_convultion_VerticalCoordinate(SINSstate)
                                            * SimpleOperations.ArrayToMatrix(KalmanVars.CovarianceMatrixS_p)
                                            * SimpleOperations.ArrayToMatrix(KalmanVars.CovarianceMatrixS_p).Transpose()
                                            * SimpleOperations.C_convultion_VerticalCoordinate(SINSstate).Transpose();
                    ...
                    for (int ii = 0; ii < tmp_dim; ii++)
                        for (int ji = ii; ji < tmp_dim; ji++)
                            str_P += CovarianceMatrix_SP_Straight_1[ii * tmp_dim + ji].ToString() + " ";
                }
                ...
                if (SimpleData.iMxSmthd >= 4)
                {
                    ...
                    MatrixS_For_VerticalVelocity = SimpleOperations.C_convultion_VerticalVelocity(SINSstate)
                                            * SimpleOperations.ArrayToMatrix(KalmanVars.CovarianceMatrixS_p)
                                            * SimpleOperations.ArrayToMatrix(KalmanVars.CovarianceMatrixS_p).Transpose()
                                            * SimpleOperations.C_convultion_VerticalVelocity(SINSstate).Transpose();
