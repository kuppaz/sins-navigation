...
namespace Common_Namespace
{
    ...
    public class Kalman_Vars
    {
        ...
        public double[,] ErrorConditionVector_Straight = new double[100000, SimpleData.iMx];
        public double[,] ErrorConditionVector_Smoothed = new double[100000, SimpleData.iMx];
        public double[,] CovarianceMatrixS_Straight = new double[100000, SimpleData.iMx * SimpleData.iMx];
        public double[,] CovarianceMatrixS_Smoothed = new double[100000, SimpleData.iMx * SimpleData.iMx];
